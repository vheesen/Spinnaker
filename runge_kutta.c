...
void rk_4_cylindrical(double h)
{
    ...
    k2_y = h * ( d2N_dz2 (cr[i][j].z + h / 2.0, cr[i][j].N + k1_N / 2.0, 
                        cr[i][j].y + k1_y / 2.0, 
                        cr[i][j].E, cr[i][j].gamma, cr[i][j].dN_dE) -
                 (cr[i][j].y + k1_y / 2.0) / (cr[i][j].z + h / 2.0 ) );
    ...
    k3_y = h * ( d2N_dz2 (cr[i][j].z + h / 2.0, cr[i][j].N + k2_N / 2.0, 
                        cr[i][j].y + k2_y / 2.0, 
                        cr[i][j].E, cr[i][j].gamma, cr[i][j].dN_dE) -
                 (cr[i][j].y + k2_y / 2.0) / (cr[i][j].z + h / 2.0) );
...
void rk_4_radial(double h)
{
    ...
    k2_y = h * ( d2N_dz2 (cr[i][j].z + h / 2.0, cr[i][j].N + k1_N / 2.0, 
                        cr[i][j].y + k1_y / 2.0, 
                        cr[i][j].E, cr[i][j].gamma, cr[i][j].dN_dE) -
                 2.0 * (cr[i][j].y + k1_y / 2.0) / (cr[i][j].z + h / 2.0 ) );
    ...
    k3_y = h * ( d2N_dz2 (cr[i][j].z + h / 2.0, cr[i][j].N + k2_N / 2.0, 
                        cr[i][j].y + k2_y / 2.0, 
                        cr[i][j].E, cr[i][j].gamma, cr[i][j].dN_dE) -
                 2.0 * (cr[i][j].y + k2_y / 2.0) / (cr[i][j].z + h / 2.0) );
